...
// Source: ./src/sanity/lib/products/getCategoriesWithProducts.ts
// Variable: CATEGORIES_WITH_PRODUCTS_QUERY
// Query: *[_type == "category"] {      ...,      "products": *[        _type == "product" && references(^._id)      ] | order(name desc)    }
export type CATEGORIES_WITH_PRODUCTS_QUERYResult = Array<{
  _id: string;
  _type: "category";
  _createdAt: string;
  _updatedAt: string;
...
// Query: *[            _type == "product"            && references(*[_type == "category" && slug.current == $categorySlug]._id)        ] | order(name desc)
...
declare module "@sanity/client" {
  interface SanityQueries {
    ...
    "\n    *[_type == \"category\"] {\n      ...,\n      \"products\": *[\n        _type == \"product\" && references(^._id)\n      ] | order(name desc)\n    }\n  ": CATEGORIES_WITH_PRODUCTS_QUERYResult;
